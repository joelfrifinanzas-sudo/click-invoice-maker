...
-- Create clients table (idempotent)
...
-- Simplified company membership policies (route-level RBAC enforces create/edit)
...
-- RPC upsert_client (idempotent create/replace)
